      ...
      <CardContent className="p-4">
        ...
        <div className="mt-3 space-y-3">
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-full bg-amber-900/30 text-amber-400 flex items-center justify-center font-bold text-sm flex-shrink-0">
              1
            </div>
            <div>
          ...
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-full bg-purple-900/30 text-purple-400 flex items-center justify-center font-bold text-sm flex-shrink-0">
              2
            </div>
            <div>
          ...
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-full bg-emerald-900/30 text-emerald-400 flex items-center justify-center font-bold text-sm flex-shrink-0">
              3
            </div>
            <div>
